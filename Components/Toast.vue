<!--template>
    <div :class="['toast-notification toast', toastStyle]" v-if="show">
...
<script>
    ...
    export default {
        ...
        /**
         * Display toast on:
         * $handler('toast', {message: string, type: string:success, time: int:3000})
         */
        mounted() {
            this.handler.on('toast', args => {
                this.title = args.title
                this.message = args.message
                this.type = args.type ?? 'success'
                this.show = true
